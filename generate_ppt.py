...
def create_deck():
    ...
    p4 = tf.add_paragraph()
    p4.text = "The ultimate engine rejuvenation, performance boost, and fuel system defense calibrated for all Petrol & Diesel vehicles on the road."
    p4.font.name = 'Inter'
    p4.font.size = Pt(13)
    ...
    add_title(slide2, "The Fuel Threat", "The Modern E20 Challenge", ORANGE)
    ...
    p.text = "Mandatory transition to E20 (20% Ethanol) blended petrol creates operational risks for modern engines:"
    p.font.name = 'Inter'
    p.font.size = Pt(15)
    ...
    add_title(slide5, "Performance Surge", "Conquering Diverse Terrains", GREEN)
    ...
    p.text = "Certified performance values representing major operational improvements on all routes:"
    p.font.name = 'Inter'
    p.font.size = Pt(15)
    p.font.color.rgb = MUTED
    p.space_after = Pt(20)
    ...
    bullets5 = [
        ...
        ("+80% Torque & Power:", " Delivers an 80% increase in power and pickup. Critical for steep roads, high-altitude climbs, and heavy cargo loads."),
        ("-80% Cooler Running:", " Decreases external engine running temperatures by up to 80%. Prevents overheating in dense metropolitan traffic jams.")
    ]
    ...
    add_title(slide7, "Environmental Impact", "Clean Combustion & Air Compliance", GREEN)
    ...
    p_intro7.text = "Supports clean air initiatives and carbon-reduction targets:"
    ...
    bullets7 = [
        ...
        ("Combustion Optimization:", " Optimizes engine combustion to neutralize standard carbon footprint outputs and ensure easy regulatory compliance.")
    ]
    ...
    p_guar.text = "Long-Term Protection and Cost Optimization"
    ...
    p_note_text.text = "Keep presentations focused on the long-term cost benefits, mechanical reliability, and peace of mind this 1,0,000 km timeline offers to individual car owners and corporate fleet managers."
    ...
    # Save presentation
    output_filename = "sundar_carbon_antidote_plus.pptx"
