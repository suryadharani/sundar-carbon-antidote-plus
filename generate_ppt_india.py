...
def create_deck():
    ...
    # ==========================================
    # SLIDE 5: PERFORMANCE SURGE (INDIA'S LANDSCAPES)
    # ==========================================
    slide5 = prs.slides.add_slide(blank_layout)
    set_slide_background(slide5)
    add_title(slide5, "Performance Surge", "Conquering India's Diverse Landscapes", GREEN)
    ...
    # ==========================================
    # SLIDE 7: MISSION LIFE & CLEAN AIR (NCAP)
    # ==========================================
    slide7 = prs.slides.add_slide(blank_layout)
    set_slide_background(slide7)
    add_title(slide7, "Eco Impact", "Mission LiFE & Clean Air Compliance", GREEN)
    ...
    p_intro7.text = "Directly aligns with India's national eco initiatives and clean air targets:"
    p_intro7.font.name = 'Inter'
    p_intro7.font.size = Pt(15)
    p_intro7.font.color.rgb = MUTED
    p_intro7.space_after = Pt(15)
    
    bullets7 = [
        ("Mission LiFE (Lifestyle for Environment):", " PM Modi's global movement encouraging mindful driving habits and energy conservation to protect our environment."),
    ...
    # Save presentation
    output_filename = "What is our Product - India_final_poster.pptx"
